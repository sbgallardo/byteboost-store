            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <button className="hidden w-10 h-10 outline-none rounded-full ring-offset-2 ring-gray-200 lg:focus:ring-2 lg:block">
                        <Avatar>
                            <AvatarImage src="https://api.uifaces.co/our-content/donated/xZ4wg2Xj.jpg"/>
                        ...
                        submenuNav.map((item, idx) => {
                            return (
                                ...
                                <li key={idx} className={`py-1 ${idx == 0 ? "border-b-2 border-indigo-600" : ""}`}>
                                    <Link href={item.path} className="block py-2 px-3 rounded-lg text-gray-700 hover:text-gray-900 hover:bg-gray-100 duration-150">
                                        {item.title}
                                    </Link>
                                </li>
                            )
